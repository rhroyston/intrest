...
// }  
  ...
  pub.test2 = function(method, host, port, path, auth){
    //this will get called with method, host, port, path, auth
    //1. do we have token?
    //1.a  is token expired?
    //  if not we need to do get fresh token
